<!--
This JSP page will be execute when admin will create Edit Admin Accounts Button from admin_panel.html page
this page will take all data from admin table and show details of admin accounts with two buttons 'update' and 'delete'
